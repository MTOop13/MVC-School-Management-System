...
public class StudentView extends JFrame {
    ...
    private JButton addButton, editButton, deleteButton, enrollButton, backButton,showAddDialogBtn,showEditDialogBtn, showEnrollDialogBtn,  viewCoursesAndGradesBtn;
    ...
    public StudentView(JFrame maiFrame) throws SQLException {
        ...
        ImageIcon plusIcon = new ImageIcon("C:\\Users\\ameen\\OneDrive\\Desktop\\addicon.jpg");
        ...
        // Create table
        studentTableModel = new DefaultTableModel(new String[]{"ID", "Age", "Name", "Gender", "Birth Place", "Birth Date", "Actions"}, 0);
...
//        JButton addButton = new JButton("Add Student");
    ...
    public String getAgeFieldText(){ return ageField.getText();}
    public String getSelectedGender(){ return maleButton.isSelected()? "Male":"Female";}
    public String getSelectedBirtPlace(){ return (String) birthPlaceComboBox.getSelectedItem();}
    public String getBirthDate(){ return ((JSpinner.DateEditor) birthDateSpinner.getEditor()).getFormat().format(birthDateSpinner.getValue());}
    public JTable getStudentTable() { return studentTable;}
    public JTable getEnrollInCoursesTable() { return enrollInCoursesTable;}
    public int getSelectedStudentRow() {return studentTable.getSelectedRow();}
    ...
    public JButton getViewCoursesAndGradesBtn() {return viewCoursesAndGradesBtn;}
...
//        enrollInCoursesTable.setDefaultRenderer(Object.class, new CustomCellRenderer());
...
//        JOptionPane.showMessageDialog(this, enrollInCoursesScrollPane, "Enroll in a Course", JOptionPane.PLAIN_MESSAGE);
    }
